...
namespace SK_Dev
{
    internal class GitHubReferences
    {
        static async Task Main(string[] args)
        {
            ...
            IConfiguration config = new ConfigurationBuilder()
                ...
                .AddUserSecrets<GitHubReferences>()
                .Build();
            ...
            builder.AddAzureAIInferenceChatCompletion(config["Github:modelid"]!, config["Github:apikey"], new Uri(config["Github:endpoint"]!));
